<a href="./account/logout_user.php">logout</a>
    ...
    <div class="block-slider block-slider4">
        <ul class="" id="bxslider-home4">
            ...
            ?>
                    ...
                    <li>
                        <img src="<?php echo $array['img'] ?>" style="width : 200px ; height : 200px;" alt="Slide">
                        <div class="caption-group">
                            <h2 class="caption title">
                                <span class="primary"><strong><?php echo $array['tensp'] ?></strong></span>
                            </h2>
                            <h4 class="caption subtitle"><?php echo $array['gia'] ?> VND</h4>
                            <a class="caption button-radius" href="cart.php?id=<?php echo $array['idsp'] ?>"><span class="icon"></span>Shop now</a>
                        </div>
                    </li>
            <?php
            }
                        ...
                        ?>
                                ...
                                <div id="single-product" class="single-product">
                                    <div class="product-f-image">
                                        ` <img id="single-product-img" src="<?php echo $array['img'] ?>" style="width = 270px; height = 120px;" alt="">
                                        <div class="product-hover">
                                            <a href="cart.php?id=<?php echo $array['idsp'] ?>" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>mua sản phẩm</a>
                                            <a href="single-product.php?search=<?php echo $array['tensp'] ?>" class="view-details-link"><i class="fa fa-link"></i> xem chi tiết</a>
                                        </div>
                                    </div>

                                    <h2 id="single-product-tieude"><a href="single-product.html"><?php echo $array['tensp']; ?></a></h2>

                                    <div id="single-product-gia" class="product-carousel-price">
                                        <ins><?php echo $array['gia'] ?> VND</ins>
                                        <!-- <del>$100.00</del> -->
                                    </div>
                                </div>
                        <?php
